...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.handleSuccess = function (data) {
        this.datafound = true;
        this.isLoading = false;
        this.users = data;
    };
    ...
    AppComponent.prototype.searchbankdata = function (query, p) {
        var _this = this;
        this.isLoading = true;
        this.query = query;
        this.p = p;
        ...
        this.postsSub = this._dataService
            ...
            _this.users = postData.posts;
            _this.handleSuccess(_this.users);
        });
    };
    AppComponent.prototype.onChangedPage = function (pageData) {
        var _this = this;
        // this.isLoading = true;
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getPosts = function (postsPerPage, currentPage, query, p) {
        var _this = this;
        var array = [];
        var post;
        var i = 0, m = 0;
        this._http
            .get(this.appUrl + query.toUpperCase() + '&&city=' + p).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (postsData) {
            while (postsData[i]) {
                i++;
            }
            for (var k = (postsPerPage * (currentPage - 1)); k <= ((postsPerPage * (currentPage - 1) + postsPerPage) - 1); k++) {
                if (k >= i) {
                    break;
                }
                array[m] = postsData[k];
    ...
    DataService.prototype.getPostUpdateListener = function () {
        return this.postsUpdated.asObservable();
    };
    DataService.prototype.getUsers = function (query, p) {
